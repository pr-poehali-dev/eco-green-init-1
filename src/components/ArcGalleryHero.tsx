...
const ArcGalleryHero = ({
  ...
  return (
    <section className={`relative overflow-hidden min-h-screen flex flex-col ${className}`} style={{ backgroundImage: 'url(https://cdn.poehali.dev/projects/6aa3f227-8c87-4486-977a-050a2812fc72/bucket/9a3b6ec3-f75d-42b6-ad4e-9c1ccb9668e8.jpeg)', backgroundSize: 'cover', backgroundPosition: 'center', backgroundRepeat: 'no-repeat', backgroundColor: '#000' }}>
      <div
      ...
      <div className="relative z-10 flex-1 flex items-center justify-center px-6 -mt-40 md:-mt-52 lg:-mt-64">
        <div className="text-center max-w-2xl px-6 opacity-0 animate-fade-in" style={{ animationDelay: '800ms', animationFillMode: 'forwards' }}>
          ...
          <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <button className="w-full sm:w-auto px-6 py-3 rounded-full border border-white/60 text-white hover:bg-white/20 transition-all duration-200">
